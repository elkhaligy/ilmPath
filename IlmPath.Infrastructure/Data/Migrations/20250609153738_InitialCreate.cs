        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserBookmarks_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAppliedOnItem = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppliedCoupons_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderDetails_Enrollments_EnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppliedCoupons_PaymentId",
                table: "AppliedCoupons",
                column: "PaymentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarks_CourseId",
                table: "UserBookmarks",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarks_UserId_CourseId",
                table: "UserBookmarks",
                columns: new[] { "UserId", "CourseId" },
                unique: true);
        }
